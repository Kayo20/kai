...
type EventItem = {
  ...
  venue?: { address?: { address_1?: string } } | null;
  url?: string | null;
};
      ...
      <div className="container mx-auto px-4">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-16 space-y-4">
            ...
            <p className="text-gray-500 text-lg">{t('events.loading')}</p>
          </div>
        )}
        ...
        {!loading && error && (
          <div className="text-center py-12 space-y-4">
            ...
            <p className="text-gray-600 text-sm">{t('events.error_msg')}</p>
          </div>
        )}
            ...
            {events.map((event: EventItem) => (
              ...
              >
                ...
                <CardFooter className="pt-0">
                  ...
                  >
                    {t('view_event', { defaultValue: 'View Event' })}
        ...
        {!loading && !error && events.length === 0 && (
          <div className="text-center py-16 space-y-6">
            <p className="text-gray-600 text-lg">{t('events.not_found')}</p>
            <p className="text-gray-500">{t('events.check_back')}</p>
          </div>
        )}
